---
layout: default
title: "Módulo de Produção Científica"
---
...
O módulo mensura a atividade técnico-científica dos egressos da RFEPCT por meio da identificação de produções registradas em bases curriculares e científicas. Utiliza os egressos como população de referência e os registros de produção científica como evidência operacional de atividade científica.
...
<table border="1" cellspacing="0" cellpadding="5">
  <tbody>
    <tr><td style="width: 30%"><strong>Indicadores centrais</strong></td><td>Total de egressos com Currículo Lattes · Total de egressos · Taxa de egressos com Lattes · Total de Produção Científica · Total de egressos com Produção · Média de Produção Científica.</td></tr>
...
### 04 · Total de Produção Científica · *Quanto maior, melhor*
...
<table border="1" cellspacing="0" cellpadding="5">
  <tbody>
    ...
    <tr><td><strong>Polaridade</strong></td><td>Quanto maior, melhor. Valores elevados indicam que um número maior de egressos da RFEPCT está engajado em atividades de produção científica, científica, tecnológica ou cultural — o que reflete positivamente sobre o impacto formativo das instituições.</td></tr>
    <tr><td><strong>Agregação máxima / mínima</strong></td><td>Rede Federal / Unidade · campus</td></tr>
...
### 06 · Média de Produção Científica · *Quanto maior, melhor*
...
<table border="1" cellspacing="0" cellpadding="5">
  ...
  <tbody>
    ...
    <tr><td>Média de produção científica por UF</td><td>Média de produções registradas nos currículos Lattes dos egressos segundo a UF.</td><td>Identificar diferenças territoriais na intensidade da produção registrada.</td></tr>
    <tr><td>Média de produção científica por campus</td><td>Média de produções nos currículos Lattes segundo o campus de origem.</td><td>Comparar a intensidade da produção entre unidades institucionais.</td></tr>
    <tr><td>Número de produção por curso</td><td>Quantidade de produções nos currículos Lattes segundo o curso concluído.</td><td>Identificar cursos com maior concentração de produção científica registrada.</td></tr>
    ...
    <tr><td>Número de produção por categoria</td><td>Quantidade de produções segundo categorias gerais — bibliográfica, técnica ou propriedade intelectual.</td><td>Caracterizar a composição geral da produção científica dos egressos.</td></tr>
